...
dummies_fit # 1 nonseasonal AR term, 1 seasonal MA term
...
arima.dummies <- Arima(trainingTS, order=c(1,0,0), seasonal = c(0,0,1), xreg = reg.ozone)
...
dummies_pred <- forecast(arima.dummies, xreg = reg.ozone, h = 12)
